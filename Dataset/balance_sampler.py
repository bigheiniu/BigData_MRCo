...
class BalancedBatchSampler(torch.utils.data.sampler.Sampler):
    ...
    def __iter__(self):
        ...
        while self.indices[self.currentkey] < self.balanced_max - 1:
            self.indices[self.currentkey] += 1
            batch.append(self.dataset[self.keys[self.currentkey]][self.indices[self.currentkey]])
    ...
    def __len__(self):
        # force dropout last one
        return self.balanced_max * len(self.keys) // self.batch_size
